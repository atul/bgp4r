...
OptionParser.new do |opts|
  opts.banner = "Usage: bgp_advertise_attr.rb [options]"
...
#  Local_pref.new(200),
  Communities.new(*("100:1 200:1 300:1 #{rand(9999)}:22 324:3432 3344:343 4466:6436 #{rand(5445)}:3454 3545:5677 5754:#{rand(9999)}".split.map { |com| com.to_i})),
  As_path.new(*("790 90 #{rand(60000)} #{rand(60000)} 544 56 67 889 3111 777 8 879 0900 88 7654 3211 113 43434 666 343 4534 667 #{rand(60000)}".split.map { |as| as.to_i}))
)
pp pa4
...
begin
  ...
  nlris = Nlri.new
   (1..@times4.to_i).each do |n|
     ...
     neighbor.send_message Update.new(pa4.replace(Communities.new(*("100:1 200:1 300:1 #{rand(9999)}:22 324:3432 3344:343 \
4466:6436 #{rand(5445)}:3454 3545:5677 5754:#{rand(9999)}".split.map { |com| com.to_i})), AS_path.new(*("790 90 #{rand(60000)} \
 #{rand(60000)} 544 56 67 889 3111 777 8 879 0900 88 7654 3211 113 43434 666 343 4534 667 #{rand(60000)}".split.map { |as| as.to_i})) ), nlris)
